...
def generate_arrays_from_file(lines, batch_size):
    ...
    while 1:
        ...
        for _ in range(batch_size):
            ...
            # 从文件中读取图像
            img = Image.open(r"/home/zhouning/datasets/bili_seg/jpg" + '/' + name)
            ...
            # 从文件中读取图像
            img = Image.open(r"/home/zhouning/datasets/bili_seg/png" + '/' + name)
...
if __name__ == "__main__":
    ...
    # 打开数据集的txt
    with open(r"/home/zhouning/datasets/bili_seg/train.txt", "r") as f:
        lines = f.readlines()
